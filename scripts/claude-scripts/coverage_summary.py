...
Usage (run from any directory):
  ...
  python3 $WALLY/addins/riscv-arch-test-claude/scripts/claude-scripts/coverage_summary.py

  # Show which bins are missing for a specific instruction (across all SEWs)
  python3 $WALLY/addins/riscv-arch-test-claude/scripts/claude-scripts/coverage_summary.py --bins vfadd.vv
